...
namespace App
{
	...
	static const std::unordered_map<u32, VK_KEYBOARD> VK_MAP = {
		...
		{ VK_OEM_1, VK_KB_OEM_SEMICOLON },
		{ VK_OEM_2, VK_KB_OEM_FORWARD_SLASH },
		{ VK_OEM_3, VK_KB_OEM_TILDE },
		{ VK_OEM_4, VK_KB_OEM_LBRACKET },
		{ VK_OEM_5, VK_KB_OEM_BACK_SLASH },
		{ VK_OEM_6, VK_KB_OEM_RBRACKET },
		{ VK_OEM_7, VK_KB_OEM_QUOTE },
		{ VK_OEM_8, VK_KB_OEM_MISC },
